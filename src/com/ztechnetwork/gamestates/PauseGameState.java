...
public class PauseGameState extends GameState {
	...
	public PauseGameState(GameStateManager gsm) {
		super(gsm);
		init();
	}
	...
	public void draw(Graphics2D g) {
		...
		g.setFont(titleFont);
		g.drawString("P A U S E", 190, 130);
	...
	private void select() {
		...
		// go to level select
		if(currentChoice == 0) {
			nextState = GameStateManager.PLAYING_STATE;
			fadeInTimer = -1;
			fadeOutTimer = 0;
